...
class CalendarEntry(models.Model):
    ...
    description = models.TextField(_("description"), help_text=_("Check out <a href='http://daringfireball.net/projects/markdown/basics'>this link</a> for how to use markdown syntax"), blank=True)
